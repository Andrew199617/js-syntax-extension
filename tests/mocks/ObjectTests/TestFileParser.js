...
const TestFileParser = {
  ...
  create() {
     ...
     */
    testFileParser.beginCharacter = 0;

    /**
     * @description The current end line being parsed.
     */
    testFileParser.endLine = 0;

    /**
     * @description The character that ends the parse. "This line is being parsed" <- d is the endCharacter.
     */
    testFileParser.endCharacter = 0;

    /** @type {EnumParserType} */
    testFileParser.enumParser = EnumParser.create(testFileParser);

    /** @type {FunctionParserType} */
    testFileParser.functionParser = FunctionParser.create(this.parseValue.bind(testFileParser));
     ...
     * @type {string}
     */
    testFileParser.propsInterface = null;

    /**
     * @description Interface for parsed state.
     * @type {string}
     */
    testFileParser.stateInterface = null;

    /**
     * @description Whether the current object we are parsing is a React Object.
     */
    testFileParser.isReactComponent = false;

    /**
     * @description The content of the file.
     */
    testFileParser.content = null;
  ...
  */
  ...
  async parseValue(value) {
    ...
    if(value.includes('{') && value.includes(':')) {
      const tempParser = TestFileParser.create();
